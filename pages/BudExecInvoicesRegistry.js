...
class InvoicesRegistry {
    ...
    async navigateToPage() {
        ...
        await this.page.click(Locators.InvoicesRegistry.categoryMenu);
    }
    async checkTabHeader() {
        const tabHeader = await this.page.locator(Locators.InputExpenses.tabHeader);
        await expect(tabHeader).toContainText('Реестр Счет-фактуров');
    }
...
module.exports = InvoicesRegistry;