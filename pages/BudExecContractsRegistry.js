...
class ConractsRegistry {
    ...
    async navigateToPage() {
        ...
        await this.page.click(Locators.ContractsRegistry.categoryMenu);
    }
    async checkTabHeader() {
        const tabHeader = await this.page.locator(Locators.InputExpenses.tabHeader);
        await expect(tabHeader).toContainText('Реестр договоров');
    }
    async chooseRelativeDataToList() {
        ...
        await this.page.getByLabel('Итого').first().fill('220');
    }
...
module.exports = ConractsRegistry;